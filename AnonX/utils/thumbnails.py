...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        logo.thumbnail((5, 5), Image.ANTIALIAS)
        width = int((1280 - 5) / 2)
        ...
        font = ImageFont.truetype("AnonX/assets/font2.ttf", 23)
        ImageFont.truetype("AnonX/assets/font2.ttf", 35)
        arial = ImageFont.truetype("AnonX/assets/font2.ttf", 15)
        ImageFont.truetype("AnonX/assets/font.ttf", 15)
